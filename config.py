...
# نسبة الأبعاد اللي بتطلبها من ChatGPT
ASPECT_RATIO = "9:16"   # "9:16" ستوري | "4:5" بوست | "1:1" مربع | "16:9" عرضي

# المقاسات اللي بيطلّعها finish.py بعد ما تنزّل الصورة
#   story  = 1080x1920  ستوري وريلز
#   post   = 1080x1350  بوست عمودي
#   square = 1080x1080  مربع
#   4k     = 2160x3840  للطباعة والشاشات الكبيرة
OUTPUT_SIZES = ["story", "4k"]

# لما المقاس المطلوب نسبته مختلفة، وين يقص عمودياً
#   0 = من فوق | 0.30 = الافتراضي (الوجه يضل بالكادر) | 0.5 = النص
CROP_ANCHOR = 0.30

# يخلي كمان نسخة كاملة بالشعار بدون تغيير المقاس
KEEP_BRANDED_ORIGINAL = False


# ─────────────────────────────────────────────────────────────────────────────
#  إعدادات اختيارية — بتشتغل بس مع generate_rose_image.py (توليد عبر API)
#  ما بتستعملها طالما إنت بتولّد على ChatGPT
# ─────────────────────────────────────────────────────────────────────────────
RESOLUTION = "4K"
COUNT      = 2
UPSCALE_4K = True
...
# ─────────────────────────────────────────────────────────────────────────────
#  ٨) الكتابة على الصورة — جملة + اسم
#     زي الشعار: بتنحط بـ finish.py بعد التوليد، مش بالبرومبت.
#     هيك الإملاء بتضل مظبوطة ١٠٠٪ والعربي ما بيطلع مقطّع.
# ─────────────────────────────────────────────────────────────────────────────

CAPTION_ENABLED = True           # False = صورة بدون كتابة

# الجملة — عربي أو إنجليزي، خليها قصيرة
CAPTION_TEXT = "ابتسامتك تستاهل الأفضل"

# الاسم اللي بينكتب تحت الجملة — خليه "" إذا ما بدك اسم
CAPTION_NAME = "روز"

# مكان الكتابة: نفس خيارات BRAND_POSITION
#   الأفضل bottom-right مع العربي، و bottom-left مع الإنجليزي
CAPTION_POSITION = "bottom-right"

# المقاسات كنسبة من عرض الصورة
CAPTION_SIZE      = 0.058        # حجم الجملة
CAPTION_NAME_SIZE = 0.034        # حجم الاسم
CAPTION_MAX_WIDTH = 0.78         # أعرض سطر قبل ما ينزل لسطر تاني

# الألوان
CAPTION_COLOR      = "auto"      # "auto" = يختار حسب الخلفية | أو كود لون
CAPTION_NAME_COLOR = BRAND_ACCENT

# تظليل خفيف تحت الكتابة عشان تضل مقروءة على أي خلفية
CAPTION_SCRIM = True

# خط الكتابة — None = يدوّر على خط عربي بالجهاز لحاله
CAPTION_FONT = None
